...
#━━━━❮YUIWEATHERコード❯━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━#
        ...
        if message.content.startswith("y!wt "):
            ...
            if city in citycodes :
                ...
                print
                desc = f"{(resp['forecasts'][0]['temperature']['date']).split('-')[1]}月{(resp['forecasts'][0]['temperature']['date']).split('-')[2]}日{resp['forecasts'][0]['dateLabel']}の天気は**{resp['forecasts'][0]['telop']}**"
                ...
                desc += f"{(resp[f'orecasts'][1]['temperature']['date']).split('-')[1]}月{(resp['forecasts'][1]['temperature']['date']).split('-')[2]}日{resp['forecasts'][1]['dateLabel']}の天気は**{resp['forecasts'][1]['telop']}**"
                ...
                desc += f"{(resp[f'orecasts'][2]['temperature']['date']).split('-')[1]}月{(resp['forecasts'][2]['temperature']['date']).split('-')[2]}日{resp['forecasts'][2]['dateLabel']}の天気は**{resp['forecasts'][2]['telop']}**"
                desc += f"最高気温**{resp['forecasts'][2]['temperature']['max']['celsius']}℃/{resp['forecasts'][2]['temperature']['max']['fahrenheit']}℉**"
                desc += f"最低気温**{resp['forecasts'][2]['temperature']['min']['celsius']}℃/{resp['forecasts'][2]['temperature']['min']['fahrenheit']}℉**"
